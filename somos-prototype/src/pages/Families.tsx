            ...
            {DAY.map((item, i) => (
              <Reveal as="li" key={item.t} delay={i * 60}>
                <div className="grid gap-2 border-b border-ink/10 py-7 sm:grid-cols-[9rem_1fr] sm:gap-8">
                  <span className="text-[0.8rem] font-bold uppercase tracking-[0.14em] text-clay-700 sm:pt-1">
                    {item.time}
                  </span>
                  <div>
                ...
                {locations.map((loc) => (
                  <div key={loc.slug} className="rounded-card border border-ink/10 bg-white p-5">
                    ...
                    <a
                      ...
                      className="mt-1 inline-flex min-h-[44px] items-center text-clay-700 underline-offset-4 hover:underline"
                    >
                      {loc.phone}
                    </a>
                  </div>
