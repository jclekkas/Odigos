...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    shortDefinition: "The annualized interest rate on a car loan, including fees. A lower APR means less total interest paid over the life of the loan.",
    fullDefinition: "APR (Annual Percentage Rate) represents the true yearly cost of borrowing, including interest and certain fees. For auto loans, APR is the primary measure of borrowing cost. Rates vary based on credit score, loan term, and lender: excellent credit (750+) typically qualifies for 3-5% APR, good credit (700-749) for 5-7%, and fair credit (650-699) for 7-12%. Longer loan terms (72-84 months) often carry higher APRs than shorter terms (36-48 months). Always compare APRs across multiple lenders — dealer financing is not always the best rate available.",
    relatedPages: [
      { label: "Monthly Payment Trap", path: "/monthly-payment-trap" },
    ],
    seoTitle: "What Is APR on a Car Loan? Annual Percentage Rate Explained | Odigos",
    seoDescription: "APR is the annualized cost of borrowing on a car loan. Learn what's a good APR, how credit score affects it, and how to get a lower rate.",
  },
  {
    slug: "down-payment",
    term: "Down Payment",
    shortDefinition: "An upfront cash payment that reduces the amount you need to finance. Typical auto down payments are 10-20% of the vehicle price.",
    fullDefinition: "A down payment is the portion of the vehicle price you pay upfront in cash, reducing the loan amount. A larger down payment means a smaller loan, lower monthly payments, and less total interest paid. It also reduces the risk of being 'underwater' (owing more than the car is worth). Most financial advisors recommend 10-20% down on a new car and 10% on a used car. For leases, the equivalent is a 'cap cost reduction' — though many advisors recommend against large down payments on leases since the money is lost if the car is totaled or stolen.",
    relatedPages: [
      { label: "OTD Price Guide", path: "/out-the-door-price" },
    ],
    seoTitle: "How Much Down Payment for a Car? Auto Down Payment Guide | Odigos",
    seoDescription: "A down payment reduces your car loan amount and monthly payments. Learn how much to put down and why it matters.",
  },
  {
    slug: "trade-in-value",
    term: "Trade-In Value",
    shortDefinition: "The amount a dealer offers for your current vehicle when you trade it in as part of a new purchase. Usually lower than private sale value.",
    fullDefinition: "Trade-in value is what the dealer will credit you for your existing vehicle toward the purchase of a new one. It is almost always lower than what you could get selling privately, because the dealer needs to recondition and resell the vehicle at a profit. Before visiting a dealer, check your vehicle's value on KBB, Edmunds, or get instant cash offers from Carvana, CarMax, or Vroom to establish a baseline. Always negotiate the trade-in value separately from the new vehicle price — dealers may inflate the trade-in offer while raising the new vehicle price to compensate.",
    relatedPages: [
      { label: "Trade-In Tax Credit", path: "/glossary/trade-in-tax-credit" },
      { label: "Dealer Pricing Tactics", path: "/dealer-pricing-tactics" },
    ],
    seoTitle: "What Is My Car's Trade-In Value? How Dealers Price Trade-Ins | Odigos",
    seoDescription: "Trade-in value is what a dealer offers for your current car. Learn how to get a fair price and avoid common dealer tactics.",
  },
  {
    slug: "buyers-order",
    term: "Buyer's Order",
    shortDefinition: "The official document itemizing every charge in a vehicle purchase — vehicle price, fees, taxes, and add-ons. Review it carefully before signing.",
    fullDefinition: "A buyer's order (also called a purchase order or deal jacket) is the binding document that lists every financial component of your vehicle purchase. It should include: the negotiated vehicle price, all dealer fees (doc fee, add-ons), government fees (tax, title, registration), trade-in credit, down payment, and the final out-the-door price. Never sign a buyer's order without reading every line item. Charges that appear on the buyer's order that weren't in your original quote are a red flag — this is where junk fees often show up for the first time.",
    relatedPages: [
      { label: "Out-the-Door Price", path: "/out-the-door-price" },
      { label: "Hidden Dealer Fees", path: "/hidden-dealer-fees" },
      { label: "Finance Office Changed Numbers", path: "/finance-office-changed-the-numbers" },
    ],
    seoTitle: "What Is a Buyer's Order? Car Purchase Order Explained | Odigos",
    seoDescription: "A buyer's order itemizes every charge in your car deal. Learn what to look for and how to catch hidden fees before signing.",
  },
  {
    slug: "finance-reserve",
    term: "Finance Reserve (Dealer Markup on APR)",
    shortDefinition: "The hidden profit a dealer makes by marking up your interest rate above what the lender approved. Can add hundreds or thousands to your total cost.",
    fullDefinition: "Finance reserve (also called dealer reserve or rate markup) is the difference between the interest rate a lender approves for you and the higher rate the dealer actually offers you. For example, if the bank approves you at 4.5% but the dealer tells you the rate is 6.5%, that 2% difference is the finance reserve — pure profit for the dealer. This markup can add $1,000-$3,000+ to your total loan cost. To protect yourself: get pre-approved by your own bank or credit union before visiting the dealer, then compare their offer. Many states cap the maximum markup a dealer can add (typically 1-2.5%).",
    relatedPages: [
      { label: "Dealer Pricing Tactics", path: "/dealer-pricing-tactics" },
    ],
    seoTitle: "What Is Finance Reserve? Dealer APR Markup Explained | Odigos",
    seoDescription: "Finance reserve is the hidden profit dealers make by marking up your interest rate. Learn how to detect it and get a better rate.",
  },
  {
    slug: "negative-equity",
    term: "Negative Equity (Underwater / Upside Down)",
    shortDefinition: "When you owe more on your car loan than the vehicle is worth. Common with low down payments, long loan terms, or rapid depreciation.",
    fullDefinition: "Negative equity means your loan balance exceeds your vehicle's current market value — you're 'underwater' or 'upside down.' For example, owing $25,000 on a car worth $20,000 means $5,000 in negative equity. This is common in the first 1-3 years of ownership, especially with low/no down payments or 72-84 month loan terms. Negative equity becomes a problem when you want to sell or trade in — the shortfall either comes out of pocket or gets rolled into your next loan (creating a debt cycle). GAP insurance exists specifically to cover this risk if the vehicle is totaled.",
    relatedPages: [
      { label: "GAP Insurance", path: "/glossary/gap-insurance" },
    ],
    seoTitle: "What Is Negative Equity? Underwater Car Loan Explained | Odigos",
    seoDescription: "Negative equity means you owe more than your car is worth. Learn why it happens, when it's a problem, and how to avoid it.",
  },
  {
    slug: "monroney-sticker",
    term: "Monroney Sticker (Window Sticker)",
    shortDefinition: "The federally mandated label on every new car showing MSRP, standard equipment, optional packages, fuel economy, and destination charge.",
    fullDefinition: "The Monroney sticker (named after the 1958 Automobile Information Disclosure Act sponsored by Senator Mike Monroney) is the window sticker affixed to every new vehicle sold in the U.S. It is required by federal law and must include: the manufacturer's suggested retail price (MSRP), standard equipment, factory-installed options and packages, destination charge, EPA fuel economy ratings, and crash test safety ratings. The Monroney sticker price is the starting point for negotiation — it is not the price you should pay. Any dealer-added sticker (sometimes called an 'addendum sticker') placed next to the Monroney sticker showing additional charges is from the dealer, not the manufacturer.",
    relatedPages: [
      { label: "MSRP", path: "/glossary/msrp" },
      { label: "Market Adjustment", path: "/glossary/market-adjustment" },
    ],
    seoTitle: "What Is a Monroney Sticker? Window Sticker Explained | Odigos",
    seoDescription: "The Monroney sticker is the federally required window sticker showing MSRP and specs. Learn what it includes and how to read it.",
  },
  {
    slug: "lease-transfer",
    term: "Lease Transfer (Lease Assumption)",
    shortDefinition: "Transferring your remaining lease obligation to another person. A cheaper alternative to early termination, typically costing $300-$500 in transfer fees.",
    fullDefinition: "A lease transfer (or lease assumption) allows you to transfer your remaining lease payments and obligations to another person. Services like Swapalease and LeaseTrader connect lease holders with buyers looking for short-term leases. Transfer fees are typically $300-$500, charged by the leasing company. Not all manufacturers allow lease transfers — check your contract. For the original lessee, a transfer eliminates remaining payments without the heavy penalties of early termination. For the new lessee, it offers a short-term lease without the upfront costs of a new one.",
    relatedPages: [
      { label: "Early Termination Fee", path: "/glossary/early-termination-fee" },
      { label: "Lease End Options", path: "/lease-end-options" },
    ],
    seoTitle: "What Is a Lease Transfer? Lease Assumption Explained | Odigos",
    seoDescription: "A lease transfer lets you hand off your lease to someone else for a $300-$500 fee. Learn how it works and when it beats early termination.",
  },
  {
    slug: "excess-wear-and-tear",
    term: "Excess Wear and Tear (Lease)",
    shortDefinition: "Charges assessed at lease end for damage beyond 'normal use' — dents, scratches, stained interiors, or tire wear below minimum tread depth.",
    fullDefinition: "Excess wear and tear charges are assessed when you return a leased vehicle with damage that goes beyond what the leasing company considers 'normal use.' Common charges include: dents or scratches longer than a credit card, chipped windshields, interior stains or burns, tires below 4/32\" tread depth, and missing equipment. Charges can range from $100 to several thousand dollars depending on severity. Many manufacturers offer wear-and-tear protection packages ($300-$600 at lease inception) that cover a certain dollar amount of damage. Before your lease-end inspection, consider getting minor damage repaired independently — it's often cheaper than the leasing company's charges.",
    relatedPages: [
      { label: "Car Lease Fees Explained", path: "/car-lease-fees-explained" },
      { label: "Lease End Options", path: "/lease-end-options" },
    ],
    seoTitle: "What Is Excess Wear and Tear? Lease-End Charges Explained | Odigos",
    seoDescription: "Excess wear and tear charges hit at lease end for dents, scratches, and tire wear. Learn what counts and how to minimize costs.",
  },
];
