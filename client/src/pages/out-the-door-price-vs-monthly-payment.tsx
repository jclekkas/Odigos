  ...
  return (
    <ArticleLayout title="Out-the-Door Price vs. Monthly Payment: What Dealers Hide">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <h2 className="text-2xl font-semibold text-foreground">The Monthly Payment Is a Compression</h2>
        <p className="text-muted-foreground">
        ...
        <p className="text-muted-foreground">Four variables feed the monthly payment number:</p>
        ...
        <h2 className="text-2xl font-semibold text-foreground">How Extending the Term Inflates Total Cost</h2>
        <p className="text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold text-foreground">The APR Markup You Can't See</h2>
        <p className="text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold text-foreground">Add-Ons Rolled Into the Payment</h2>
        <p className="text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold text-foreground">How to Keep OTD Price and Financing Separate</h2>
        <p className="text-muted-foreground">
        ...
        <p className="text-muted-foreground">In practice:</p>
        ...
        <h2 className="text-2xl font-semibold text-foreground">The Signal: When to Walk Away</h2>
        <p className="text-muted-foreground">
