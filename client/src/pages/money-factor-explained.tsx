  ...
  return (
    <ArticleLayout title="Money Factor Explained">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <h2 className="text-2xl font-semibold text-foreground">What Is Money Factor?</h2>
        ...
        <h2 className="text-2xl font-semibold text-foreground">How to Convert Money Factor to APR</h2>
        <p className="text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold text-foreground">What's a Good Money Factor?</h2>
        <p className="text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold text-foreground">Who Sets the Money Factor?</h2>
        <p className="text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold text-foreground">How Dealers Mark Up the Money Factor</h2>
        <p className="text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold text-foreground">How to Negotiate the Money Factor</h2>
        <p className="text-muted-foreground">
