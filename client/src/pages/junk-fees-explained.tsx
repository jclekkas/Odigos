  ...
  return (
    <ArticleLayout title="Junk Fees Explained">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">What Makes a Fee a "Junk Fee"?</h2>
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">The Most Common Dealer Junk Fees</h2>

        <h3 className="text-xl font-semibold mt-8 mb-3 text-foreground">1. Nitrogen Tire Fill ($50–$300)</h3>
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3 text-foreground">2. VIN Etching ($100–$400)</h3>
        <p className="text-muted-foreground mb-6">
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3 text-foreground">3. Paint Protection / Ceramic Coating ($300–$1,500)</h3>
        <p className="text-muted-foreground mb-6">
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3 text-foreground">4. Fabric / Interior Protection ($200–$600)</h3>
        <p className="text-muted-foreground mb-6">
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3 text-foreground">5. Dealer Prep Fee ($200–$500)</h3>
        <p className="text-muted-foreground mb-6">
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3 text-foreground">6. Anti-Theft Package ($200–$800)</h3>
        <p className="text-muted-foreground mb-6">
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3 text-foreground">7. Undercoating ($300–$1,000)</h3>
        <p className="text-muted-foreground mb-6">
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3 text-foreground">8. Pinstriping ($100–$500)</h3>
        <p className="text-muted-foreground mb-6">
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3 text-foreground">9. Window Tint ($100–$500)</h3>
        <p className="text-muted-foreground mb-6">
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3 text-foreground">10. Wheel Locks ($50–$200)</h3>
        <p className="text-muted-foreground mb-6">
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3 text-foreground">11. Market Adjustment / ADM ($500–$10,000+)</h3>
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">Fees That Are NOT Junk Fees</h2>
        <p className="text-muted-foreground mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">How to Fight Back Against Junk Fees</h2>
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">The FTC and Junk Fees in 2026</h2>
        <p className="text-muted-foreground mb-8">
