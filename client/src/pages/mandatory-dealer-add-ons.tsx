      ...
      <Helmet>
        <script type="application/ld+json">{JSON.stringify(articleSchema({ title: "Mandatory Dealer Add-Ons: Which Are Actually Required by the Dealer | Odigos", description: "Understand which dealer add-ons are truly required, which are optional, and why dealers pre-install extras to increase profit.", path: "/mandatory-dealer-add-ons" }))}</script>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-foreground">What Counts as a Dealer Add-On?</h2>
            ...
            <h2 className="text-2xl font-semibold text-foreground">What's Actually Required by Law?</h2>
            <p className="text-muted-foreground">
            ...
            <h3 className="text-lg font-semibold text-foreground">Paint Protection / Ceramic Coating</h3>
            <p className="text-muted-foreground">
            ...
            <h3 className="text-lg font-semibold text-foreground">Nitrogen-Filled Tires</h3>
            <p className="text-muted-foreground">
            ...
            <h3 className="text-lg font-semibold text-foreground">VIN Etching</h3>
            <p className="text-muted-foreground">
            ...
            <h3 className="text-lg font-semibold text-foreground">Protection Packages / Dealer Bundles</h3>
            <p className="text-muted-foreground">
            ...
            <h2 className="text-2xl font-semibold text-foreground">When Dealers Say "It's Already Installed"</h2>
            <p className="text-muted-foreground">
            ...
            <h2 className="text-2xl font-semibold text-foreground">Why Getting a Written OTD Price Matters</h2>
            <p className="text-muted-foreground">
