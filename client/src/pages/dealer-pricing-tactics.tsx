    ...
    <ArticleLayout title="Dealer Pricing Tactics: Complete Guide (2026)">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="text-lg text-muted-foreground mb-4">
              Car dealers use a range of pricing tactics to keep buyers in the dark — from refusing to give out-the-door prices to bundling add-ons that inflate the final cost (see <a href="https://www.edmunds.com/car-buying/what-fees-should-you-pay-at-a-car-dealership.html" target="_blank" rel="noopener" className="underline text-foreground">Edmunds' breakdown of common fees</a> for context). Understanding these tactics is the first step to negotiating from a position of strength. Our guide on <Link href="/hidden-dealer-fees" className="underline text-foreground">hidden dealer fees</Link> covers the most common charges buyers encounter in quotes.
            </p>
            <p className="text-lg text-muted-foreground mb-10">
              Odigos helps you identify these tactics in real dealer quotes, emails, and texts — so you know what to ask and what to push back on before you visit the dealership. For a broader overview of your rights as a buyer, see the <a href="https://consumer.ftc.gov/articles/buying-new-car" target="_blank" rel="noopener" className="underline text-foreground">FTC's guide for car buyers</a>. You can also <Link href="/analyze" className="underline text-foreground">paste your current quote into Odigos</Link> to have it flagged automatically.
            </p>
          </div>
