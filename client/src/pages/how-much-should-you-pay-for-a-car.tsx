  ...
  return (
    <ArticleLayout title="How Much Should You Pay for a Car?">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <h2 className="text-2xl font-semibold text-foreground">The two numbers that actually matter</h2>
        ...
        <h2 className="text-2xl font-semibold text-foreground">Why monthly payment is the wrong anchor</h2>
