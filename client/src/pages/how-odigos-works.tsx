  ...
  return (
    <ArticleLayout title="How Odigos Works" showBreadcrumbs={false}>
      ...
      <div className="space-y-10 text-base leading-relaxed">
        ...
        <section>
          ...
          <ul className="space-y-2 ml-10 mb-4">
            <li className="flex items-center gap-3">
              ...
              <span className="text-muted-foreground">A <strong className="text-foreground">GO / NO-GO verdict</strong> with a deal score and confidence level</span>
            </li>
            <li className="flex items-center gap-3">
              <CheckCircle2 className="h-4 w-4 shrink-0 text-green-500" />
              <span className="text-muted-foreground">The <strong className="text-foreground">pricing details detected</strong> in the quote</span>
            </li>
          </ul>
        ...
        <div className="pt-4">
          <Button asChild size="lg" className="gap-2" data-testid="button-cta-how-it-works">
            <Link href="/analyze">
