  ...
  return (
    <ArticleLayout title="Are Dealer Fees Negotiable?">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <h2 className="text-2xl font-semibold text-foreground">Fees That Are Fixed — Not Negotiable</h2>
        ...
        <h2 className="text-2xl font-semibold text-foreground">Fees That Are Dealer-Controlled</h2>
        <p className="text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold text-foreground">The OTD Strategy: Negotiate the Total, Not the Line Items</h2>
        <p className="text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold text-foreground">When Dealers Say Fees Are "Mandatory"</h2>
        <p className="text-muted-foreground">
