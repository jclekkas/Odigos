  ...
  return (
    <ArticleLayout title="What Is a Dealer Doc Fee?">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <h2 className="text-2xl font-semibold text-foreground">What Does a Doc Fee Actually Cover?</h2>
        ...
        <h2 className="text-2xl font-semibold text-foreground">Is the Doc Fee a Government Charge?</h2>
        <p className="text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold text-foreground">How Doc Fees Vary by State</h2>
        <p className="text-muted-foreground">
        ...
        <ul className="space-y-2 mb-4 text-muted-foreground">
          ...
          <li className="flex items-start gap-2">
            <span className="text-muted-foreground mt-1.5 shrink-0">•</span>
            <span><strong className="text-foreground">No-cap states:</strong> Florida, Georgia, Colorado, and many others have no statutory cap. Florida commonly sees $500–$1,000+, while Georgia and Colorado typically fall in the $400–$700 range.</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-muted-foreground mt-1.5 shrink-0">•</span>
        ...
        <h2 className="text-2xl font-semibold text-foreground">Why the Same Work Costs Different Amounts</h2>
        <p className="text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold text-foreground">Does the Doc Fee Apply to Every Customer?</h2>
        <p className="text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold text-foreground">How to Evaluate Whether a Doc Fee Is Normal</h2>
        <p className="text-muted-foreground">
