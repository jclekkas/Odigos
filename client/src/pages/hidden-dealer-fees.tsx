  ...
  return (
    <ArticleLayout title="Hidden Dealer Fees">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">Market Adjustment Fee</h2>
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">Dealer Prep Fee</h2>
        <p className="text-muted-foreground mb-8">
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">Dealer Reconditioning Fee</h2>
        <p className="text-muted-foreground mb-8">
        ...
        <p className="text-muted-foreground mb-8">
          A dealer-set charge for processing the paperwork involved in the sale — contracts, title transfer, and registration filing. It is not a government fee. In capped states like California or New York, it's limited by law. In no-cap states like Florida or Texas, it can reach $800–$1,000+. It's usually non-negotiable on its own but can be offset by negotiating the vehicle price. Learn more in our guide on <Link href="/dealer-doc-fee" className="underline text-foreground">dealer documentation fees</Link>.
        </p>
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">Paint Protection / Sealant</h2>
        <p className="text-muted-foreground mb-8">
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">Fabric or Leather Protection</h2>
        <p className="text-muted-foreground mb-8">
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">Protection Packages (Bundled Add-Ons)</h2>
        <p className="text-muted-foreground mb-8">
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">Advertising Fee</h2>
        <p className="text-muted-foreground mb-8">
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-foreground">What to Do When You See an Unexpected Fee</h2>
